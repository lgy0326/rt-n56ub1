...
#define STORAGE_DNSMASQBKYE_DIR	"/etc/storage"
#define STORAGE_SCRIPTS_DIR	"/etc/storage"
#define STORAGE_CRONTAB_DIR	"/etc/storage/cron/crontabs"
#define STORAGE_ADBYBYT_DIR	"/tmp/adbb/bin/data"
#define STORAGE_ADBYBYM_DIR	"/media/AiDisk_a1/adbb/bin/data"
#define STORAGE_KOOLPROXYT_DIR	"/tmp/koolproxy/data/rules"
#define STORAGE_KOOLPROXYM_DIR	"/media/AiDisk_a1/koolproxy/data/rules"
